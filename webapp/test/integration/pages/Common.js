sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/MasterTemplate2/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.MasterTemplate2.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/MasterTemplate2/localService/mockserver"], function (mockserver) {
